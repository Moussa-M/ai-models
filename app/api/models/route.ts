...
const LITELLM_URL =
  "https://raw.githubusercontent.com/BerriAI/litellm/362081c2b9f9568505fa30f3fcf95abfec792aa4/model_prices_and_context_window.json"
  ...
  try {
    ...
    const models = Object.entries(rawData)
      ...
      .filter((model) => {
        ...
        // Exclude models with deprecation_date in the past
